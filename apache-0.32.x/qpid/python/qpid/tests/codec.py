...
class IntegerTestCase(BaseDataTypes):
    ...
    def test_unsigned_octet(self):
        ...
        """
        self.assertEqual(self.callFunc('encode_octet', self.const_integer), self.const_integer_octet_encoded,
    ...
    def test_uoctet_with_fraction(self):
        ...
        """
        self.assertEqual(self.callFunc('encode_octet', 2.5), self.const_integer_octet_encoded,
    ...
    def test_unsigned_octet_decode(self):
        ...
        octet decoding
        """
        self.assertEqual(self.readFunc('decode_octet', self.const_integer_octet_encoded), self.const_integer,
                         'octect decoding FAILED...')
    ...
    def test_ushort_int(self):
        ...
        """
        self.assertEqual(self.callFunc('encode_short', self.const_integer), self.const_integer_short_encoded,
    ...
    def test_ushort_int_with_fraction(self):
        ...
        the fractional part should be ignored...
        """
        self.assertEqual(self.callFunc('encode_short', 2.5), self.const_integer_short_encoded,
    ...
    def test_ushort_int_decode(self):
        ...
        """
        self.assertEqual(self.readFunc('decode_short', self.const_integer_short_encoded), self.const_integer,
                         'unsigned short decoding FAILED...')
    ...
    def test_ulong_int(self):
        ...
        """
        self.assertEqual(self.callFunc('encode_long', self.const_integer), self.const_integer_long_encoded,
    ...
    def test_ulong_int_with_fraction(self):
        ...
        the fractional part should be ignored...
        """
        self.assertEqual(self.callFunc('encode_long', 2.5), self.const_integer_long_encoded,
    ...
    def test_ulong_int_decode(self):
        ...
        """
        self.assertEqual(self.readFunc('decode_long', self.const_integer_long_encoded), self.const_integer,
                         'unsigned long decoding FAILED...')
    ...
    def test_ulong_long_int(self):
        ...
        """
        self.assertEqual(self.callFunc('encode_longlong', self.const_integer), self.const_integer_long_long_encoded,
    ...
    def test_ulong_long_int_with_fraction(self):
        ...
        the fractional part should be ignored...
        """
        self.assertEqual(self.callFunc('encode_longlong', 2.5), self.const_integer_long_long_encoded,
    ...
    def test_ulong_long_int_decode(self):
        ...
        """
        self.assertEqual(self.readFunc('decode_longlong', self.const_integer_long_long_encoded), self.const_integer,
                         'unsigned long long decoding FAILED...')
...
class BitTestCase(BaseDataTypes):
    ...
    def test_bit3(self):
        ...
        """
        self.assertEqual(self.callFunc('encode_bit', 1, 1, 1, 0, 0, 1, 0, 1, 1, 1), '\xa7\x03',
...
class StringTestCase(BaseDataTypes):
    ...
    def test_short_string_positive_length(self):
        ...
        """
        self.assertEqual(self.callFunc('encode_shortstr', 'hello world'), '\x0bhello world',
                         'positive length short string encoding FAILED...')
    ...
    def test_short_string_decode(self):
        ...
        short string decode
        """
        self.assertEqual(self.readFunc('decode_shortstr', '\x0bhello world'), 'hello world',
                         'short string decode FAILED...')
    ...
    def test_long_string_zero_length(self):
        ...
        """
        self.assertEqual(self.callFunc('encode_longstr', ''), '\x00\x00\x00\x00',
                         '0 length long string encoding FAILED...')
    ...
    def test_long_string_positive_length(self):
        ...
        """
        self.assertEqual(self.callFunc('encode_longstr', 'hello world'), '\x00\x00\x00\x0bhello world',
                         'positive length long string encoding FAILED...')
    ...
    def test_long_string_decode(self):
        ...
        long string decode
        """
        self.assertEqual(self.readFunc('decode_longstr', '\x00\x00\x00\x0bhello world'), 'hello world',
                         'long string decode FAILED...')
...
class FieldTableTestCase(BaseDataTypes):
    ...
    def test_field_table_name_value_pair(self):
        ...
        """
        self.assertEqual(self.callFunc('encode_table', {'$key1': 'value1'}),
                         '\x00\x00\x00\x11\x05$key1S\x00\x00\x00\x06value1', 'valid name value pair encoding FAILED...')
    ...
    def test_field_table_multiple_name_value_pair(self):
        ...
        """
        self.assertEqual(self.callFunc('encode_table', self.const_field_table_dummy_dict),
    ...
    def test_field_table_decode(self):
        ...
        field table decode
        """
        self.assertEqual(self.readFunc('decode_table', self.const_field_table_dummy_dict_encoded),
...
class ContentTestCase(BaseDataTypes):
    ...
    def test_content_inline(self):
        ...
        inline content
        """
        self.assertEqual(self.callFunc('encode_content', 'hello inline message'),
                         '\x00\x00\x00\x00\x14hello inline message', 'inline content encoding FAILED...')
    ...
    def test_content_reference(self):
        ...
        reference content
        """
        self.assertEqual(self.callFunc('encode_content', ReferenceId('dummyId')), '\x01\x00\x00\x00\x07dummyId',
    ...
    def test_content_inline_decode(self):
        ...
        """
        self.assertEqual(self.readFunc('decode_content', '\x00\x00\x00\x00\x14hello inline message'),
                         'hello inline message', 'inline content decode FAILED...')
    ...
    def test_content_reference_decode(self):
        ...
        """
        self.assertEqual(self.readFunc('decode_content', '\x01\x00\x00\x00\x07dummyId').id, 'dummyId',
                         'reference content decode FAILED...')
